...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0B1E47" },
      { title: "AuditNova — Trust Meets Innovation" },
      { name: "description", content: "AuditNova: AI-powered audit, compliance, learning and startup incubation platform for Algerian SMEs and startups." },
      { name: "author", content: "AuditNova" },
      ...
      { property: "og:site_name", content: "AuditNova" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "AuditNova",
          slogan: "Trust Meets Innovation",
          description: "AI-powered audit, compliance and incubation platform for Algerian SMEs.",
        }),
      },
    ],
  }),
